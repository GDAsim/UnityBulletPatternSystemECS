namespace SplitterGun
{
    ...
    using UnityEngine;
    using static SplitterGun.GunData;
                    ...
                    switch (select)
                    {
                        case GunPatternSelect.Extra:
                            bulletPattern = new IAction[]
                            {
                                ...
                                new SplitAction
                                {
                                    splitPrefab = gunData.WithEntities[0],
                        ...
                        case GunPatternSelect.Split:
                            bulletPattern = new IAction[]
                            {
                                ...
                                new SplitAction
                                {
                                    splitPrefab = gunData.WithEntities[1],
                                    splitActions = new IAction[]
                                    {
                                        new TransformAction
                                        {
                        ...
                        case GunPatternSelect.Copy:
                            bulletPattern = new IAction[]
                            {
                                ...
                                new SplitAction
                                {
                                    ...
                                    splitDelta = new TransformData()
                                    {
                                        Rotation = Quaternion.AngleAxis(45 + 45, Vector3.up),
                                    },
                                    IsCopy = true,
